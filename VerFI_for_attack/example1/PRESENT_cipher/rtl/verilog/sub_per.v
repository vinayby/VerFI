...
module sub_per(data_o,data_i, cointoss); // this module cascades the substitution and permutation layers of the cipher and builds a 
...
substitution sub_per_substitution(.data_o(s)   ,.data_i(data_i), .cointoss(cointoss)); // input of the S-Box is data_i
